      ...
      <div className="w-full">
        ...
        <div className="relative overflow-hidden">
          ...
          {maxSlides > 0 && (
            <button 
              onClick={nextSlide}
              className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-1/2 bg-[#58C0D7] hover:bg-[#4aa8c0] text-white w-12 h-12 rounded-full flex items-center justify-center transition-colors shadow-lg z-10"
            >
