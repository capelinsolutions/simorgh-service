...
const CleanerNotifications = () => {
  ...
  const getNotificationBadge = (type: string) => {
    const configs = {
      job_assignment: { color: 'bg-blue-100 text-blue-800', label: 'New Job' },
      job_update: { color: 'bg-green-100 text-green-800', label: 'Job Update' },
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Stay updated with your job assignments and important updates
          </p>
        </div>
      ...
      {filteredNotifications.length === 0 ? (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground">
              {filter === 'all' 
                ? "You'll receive notifications about job assignments and important updates here."
